...
export interface NasaafundNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NasaafundNFT extends BaseContract {
  connect(runner?: ContractRunner | null): NasaafundNFT;
  waitForDeployment(): Promise<this>;

  interface: NasaafundNFTInterface;
